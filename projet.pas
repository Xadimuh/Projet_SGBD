    ...
    begin
         ...
         repeat
               ...
               begin
                    ...
                    gotoxy(2,42);write('n� de telephone invalide, les chiffres, ., - l''espace seulement sont autorises');
                    textcolor(black);
               end;
...
var i,min,max:integer;
    ...
    begin
         ...
         begin
              ...
              gotoxy(47,19); write('     ��������������������������Ŀ');
              gotoxy(47,20); write('     � SEM 01 � SEM 02 � ANNEE  �');
              gotoxy(47,21); write('�������������������������������Ĵ');
              for a:=1 to 8 do
              begin
                   gotoxy(47,22+2*(a-1));
                             write('     �        �        �        �');
